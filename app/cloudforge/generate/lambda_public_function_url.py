"""Hardcoded ``lambda_public_function_url`` scenario data (template engine)."""
...
from app.cloudforge.generate.fragments.core_lambda import LambdaPublicFunctionUrl
...
def _bundle() -> FragmentBundle:
    return LambdaPublicFunctionUrl().build("", Random(0), {})
