"""Template projection of ``core.kms_key_overbroad`` (empty namespace)."""
...
from app.cloudforge.generate.fragments.core_kms import KmsKeyOverbroad
...
def _bundle() -> FragmentBundle:
    return KmsKeyOverbroad().build("", Random(0), {})
