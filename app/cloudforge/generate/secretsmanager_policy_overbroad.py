"""Hardcoded ``secretsmanager_policy_overbroad`` scenario data (template engine)."""
...
from app.cloudforge.generate.fragments.core_secretsmanager import SecretsManagerPolicyOverbroad
...
def _bundle() -> FragmentBundle:
    return SecretsManagerPolicyOverbroad().build("", Random(0), {})
