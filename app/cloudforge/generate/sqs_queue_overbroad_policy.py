"""Hardcoded ``sqs_queue_overbroad_policy`` scenario data (template engine)."""
...
from app.cloudforge.generate.fragments.core_sqs import SqsQueueOverbroadPolicy
...
def _bundle() -> FragmentBundle:
    return SqsQueueOverbroadPolicy().build("", Random(0), {})
