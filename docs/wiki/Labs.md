...
These commands are in PR #147. Until that merges, use
`generate` / `validate` / `report` and treat `report.md` as the instructor
view.

## Student pack (FXL-D010)
...
dummy account ids only. See [Safety & Scope](Safety-and-Scope.md).
