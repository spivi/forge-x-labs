# Review Sheet 07 — `public_data_exposure--seed1`
...
- `vpc-prod` — **VPC** app-prod-vpc-alt (low)
- `s3-public-data` — **S3Bucket** customer-pii-alt (critical)
- `s3-locked-backups` — **S3Bucket** env-public-looking-backups (medium)
- `app-data-lake` — **Application** env-customer-data-lake (high)
- `data-customer-pii` — **DataSet** customer-pii-records-x (critical)
- `trail-main` — **LogTrail** svc-main-trail-alt (medium)
