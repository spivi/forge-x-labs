# Review Sheet 10 - `public_data_exposure--seed4`
...
- `acct-main` - **Account** svc-prod-account-b (high)
- `vpc-prod` - **VPC** svc-prod-vpc (low)
- `s3-public-data` - **S3Bucket** env-customer-pii-b (critical)
- `s3-locked-backups` - **S3Bucket** res-public-looking-backups-v2 (medium)
- `app-data-lake` - **Application** customer-data-lake-x (high)
- `data-customer-pii` - **DataSet** svc-customer-pii-records-b (critical)
- `trail-main` - **LogTrail** env-main-trail-b (medium)
- `subnet-benign-extra` - **Subnet** svc-spare-subnet-v2 (low)
